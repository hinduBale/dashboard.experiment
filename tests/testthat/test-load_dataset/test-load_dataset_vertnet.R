...
# testthat::test_file("./tests/testthat/test-load_dataset_vertnet.R")
...
testthat::test_that("Data loads up properly", {
  ...
  ## Expectation 1
  vertNetButton <- connectionObj$findElement(using = "xpath",
                                             value = "/html/body/div[1]/div/section/div/div[1]/div[1]/div[1]/div/div/div[1]/div[5]/div/div[4]/label/span")
  vertNetButton$clickElement()
  ...
  alertBoxFound <- FALSE
  if(alertBoxText == "" | alertBoxText == "Read Data Successfully" | alertBoxText == "Querying vertnet ...") {
    alertBoxFound <- TRUE
  }
