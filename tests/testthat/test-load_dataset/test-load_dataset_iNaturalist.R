...
# testthat::test_file("./tests/testthat/test-load_dataset_iNaturalist.R")
...
testthat::test_that("Data loads up properly", {
  ...
  ## Expectation 1
  iNaturalistButton <- connectionObj$findElement(using = "xpath",
                                           value = "/html/body/div[1]/div/section/div/div[1]/div[1]/div[1]/div/div/div[1]/div[5]/div/div[6]/label/span")
  iNaturalistButton$clickElement()
  ...
  alertBoxFound <- FALSE
  if(alertBoxText == "" || alertBoxText == "Read Data Successfully" || alertBoxText == "Querying inat ...") {
    alertBoxFound <- TRUE
  }
