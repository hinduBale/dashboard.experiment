...
# testthat::test_file("./tests/testthat/test-load_dataset_bison.R")
...
testthat::test_that("Data loads up properly", {
  ...
  alertBoxFound <- FALSE
  if(alertBoxText == "" | alertBoxText == "Read Data Successfully" | alertBoxText == "Querying bison ...") {
    alertBoxFound <- TRUE
  }
