...
helper_navigate_data_overview_tab <- function() {
...
helper_navigate_missing_data_tab <- function(sec_wait_after_overview_click) {
  helper_navigate_data_overview_tab()
...
helper_navigate_spatial_tab <- function(sec_wait_after_spatial_click) {
